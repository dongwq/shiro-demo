...
//        println "signIn"
        ...
        try{
            boolean isValid = simpleCaptchaService.validateCaptcha(params.captcha)

            if(!isValid) throw new ShiroException()
            ...
            LinkedHashMap<String, Object> m = keepOriginData(params)
            ...
            // on the login page.
            log.info "Authentication failure for user '${params.username}'."
            flash.message = message(code: "validate.code.failed")
    ...
    private LinkedHashMap<String, Object> keepOriginData(def params) {
